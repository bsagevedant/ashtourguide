      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">ashTourguide</h3>
            <p className="text-sm text-muted-foreground max-w-xs">
              Redefining travel through AI-powered spatial computing and augmented reality.
              Explore with confidence, discover with context.
            </p>
          </div>
          <div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-muted-foreground">
            © 2025 ashTourguide. All rights reserved.
          </p>
